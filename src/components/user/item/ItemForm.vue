    ...
    <div>
        <form @submit.prevent="submitForm">
            ...
            <div>
                ...
                <input type="text" v-model="form.deskripsi" id="deskripsi" :disabled="true" required />
            </div>
            <div>
                <label for="stok">Stok</label>
                <input type="number" v-model="form.stok" id="stok" :disabled="true" required />
            </div>
            <div>
            ...
            <div class="button-container">
                <button type="button" @click="cancelBorrowForm">Batal</button>
